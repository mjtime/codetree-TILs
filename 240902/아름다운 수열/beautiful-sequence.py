...
for i in range(n - m + 1):
    arr_permutaion1 = list(itertools.permutations(arr_m))
    for perm in arr_permutaion1:
        if tuple(arr_n[i:i+m]) == perm:
    ...
    while True:
        ...
        arr_permutaion2 = list(itertools.permutations(temp_arr2))
    ...
    while True:
        ...
        arr_permutaion3 = list(itertools.permutations(temp_arr3))
